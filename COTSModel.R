...
SPATIALDATA_DIRECTORY <- paste(BASE_DIRECTORY,"\\Data",sep="")                          # directory for storing relevant spatial data (ASC, SHP files)
...
projection <- "+proj=utm +zone=24 +south +ellps=GRS67 +towgs84=-57,1,-41,0,0,0,0 +units=m +no_defs"
